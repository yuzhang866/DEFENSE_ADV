...
model1.load_state_dict(
    torch.load('/content/drive/My Drive/Colab Notebooks/DEFENSE_ADV/F-MNIST/checkpoint_GoogLeNet/net_26.pth'))
model1.train()
...
def train(epochs):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model1.state_dict(),
                   '/content/drive/My Drive/Colab Notebooks/DEFENSE_ADV/F-MNIST/checkpoint_GoogLeNet/net_{}.pth'.format(
                       a + 1))
        a += 1
