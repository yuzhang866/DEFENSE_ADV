...
if __name__ == '__main__':
    ...
    model1.load_state_dict(torch.load('../SavedNetworkModel/CIFAR/GoogleNet/googlenet_cifar_39.pth', map_location=torch.device(device)))
    model1.to(device)
    model1.eval()
    ...
    for i in range(epoch):
        ...
        torch.save(model2.state_dict(),
                   '../SavedNetworkModel/CIFAR/GoogleNet/Defense_BIM/googlenet_defense_bim_cifar_{}.pth'.format(i))
