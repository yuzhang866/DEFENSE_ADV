...
if __name__ == '__main__':
    ...
    model2.load_state_dict(torch.load('../SavedNetworkModel/CIFAR/ResNet101/defense_DeepFool/resnet101_defense_deepfool_cifar_40.pth',
    ...
    for i in range(41, epoch):
        ...
        torch.save(model2.state_dict(),
                   '../SavedNetworkModel/CIFAR/ResNet101/defense_DeepFool/resnet101_defense_deepfool_cifar_{}.pth'.format(i))
