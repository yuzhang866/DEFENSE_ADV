...
if __name__ == '__main__':
    ...
    adversary_bim = LinfBasicIterativeAttack(model1, loss_fn=nn.CrossEntropyLoss(reduction="sum"), eps=0.005)
    ...
    for i in range(epoch):
        ...
        torch.save(model2.state_dict(),
                   '../SavedNetworkModel/CIFAR/ResNet101/defense_BIM/resnet101_defense_bim_cifar_{}.pth'.format(epoch))
