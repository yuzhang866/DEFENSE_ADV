...
if __name__ == '__main__':
    ...
    model1.load_state_dict(torch.load('./SavedNetworkModel/CIFAR/ResNet101/resnet101_cifar_19.pth', map_location=torch.device(device)))
    model1.to(device)
    model1.eval()
    ...
    for i in range(epoch):
        ...
        torch.save(model2,
                   './SavedNetworkModel/CIFAR/ResNet101/defense_CW/resnet101_defense_cw_cifar_{}.pth'.format(i))
