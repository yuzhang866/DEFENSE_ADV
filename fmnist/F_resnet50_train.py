...
testloader = torch.utils.data.DataLoader(test_data, batch_size=50, shuffle=True, num_workers=2)
...
# net = torch.load('/content/drive/My Drive/Colab Notebooks/DEFENSE_ADV/CIFAR/ckpt.pth')
...
def train(epoch):
    ...
    print(train_loss, correct / total)
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        #     os.mkdir('checkpoint')
        torch.save(net, '/content/drive/My Drive/Colab Notebooks/DEFENSE_ADV/FMNIST/checkpoint/Fashion_resnet50.pth')
        best_acc = acc
